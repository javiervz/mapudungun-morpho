...
def verb_to_mapudungun(n_clicks, verb_esp,numero,persona,polaridad,tiempo):
    ...
    if polaridad=='positiva':## persona gramatical + base + futuro + polaridad
        ...
        if tiempo=='futuro':
            ...
            expansion+=base + '+ la (negativa)' + ' + ya (futuro)'
        else:
            traduccion=conjugacion[numero][persona]+' '+base+'la'
            expansion+=base + '+ la (negativa)'
    ...
    return 'En mapudungun, el verbo "{}" conjugado en "{}" persona "{}" en polaridad "{}" y tiempo "{}" se dice'.format(verb_esp,persona,numero,polaridad,tiempo)+' '+'"'+expansion+'"'
